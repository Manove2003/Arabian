...
import "./Brandpageheader.css";
import logo from "../../assets/image 1 (1).png";
import { FaBars, FaTimes } from "react-icons/fa";
import contactimg from "../../assets/brand.png";

class Brandpageheader extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isMenuOpen: false,
      ...
      <>
        ...
        <div style={containerStyle}>
          <div style={{ ...textStyle, ...mobileTextStyle }}>
            ...
            <h1 style={headingStyle}>Arabian Broadcast Have Strong Partners</h1>
            <p style={{ color: "#fff" }}>
