...
import "./Careerpageheader.css";
import logo from "../../assets/image 1 (1).png";
import { FaBars, FaTimes } from "react-icons/fa";
import career from "../../assets/career.png";

class Careerpageheader extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isMenuOpen: false,
      ...
      <>
        ...
        <div style={containerStyle}>
          <div style={{ ...textStyle, ...mobileTextStyle }}>
            <h3 style={subheadingStyle}>Careers!</h3>
            <h1 style={headingStyle}>Become a part of our team today!</h1>
            <p style={{ color: "#fff" }}>
            ...
            <button className="get-started-btn" style={{ marginTop: "2rem" }}>
              View Opening Jobs
            </button>
          </div>
